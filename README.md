...
Utilidad para colorear código y generar código HTML para usar en publicaciones WEB. Usando gsColorearNET para .NET Standard 2.0. (para .NET 9.0  revisión del 19/Jun/2026)
