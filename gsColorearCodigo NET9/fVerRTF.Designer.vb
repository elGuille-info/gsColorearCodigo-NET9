...
Partial Class fVerRTF
    ...
    Private Sub InitializeComponent()
        ...
        Me.btnText = New Button()
        Me.btnRTF = New Button()
        Me.SuspendLayout()
        '
        'RichTextBox1
        '
        Me.RichTextBox1.Anchor = CType((((AnchorStyles.Top Or AnchorStyles.Bottom) _
        ...
        'btnText
        '
        Me.btnText.Anchor = CType((AnchorStyles.Bottom Or AnchorStyles.Left), AnchorStyles)
        Me.btnText.AutoSize = True
        Me.btnText.Location = New System.Drawing.Point(0, 338)
        Me.btnText.Margin = New Padding(0)
        ...
        'btnRTF
        '
        Me.btnRTF.Anchor = CType((AnchorStyles.Bottom Or AnchorStyles.Left), AnchorStyles)
        Me.btnRTF.AutoSize = True
        Me.btnRTF.Location = New System.Drawing.Point(223, 338)
        Me.btnRTF.Margin = New Padding(3, 0, 0, 0)
    ...
    Private WithEvents btnRTF As Button
