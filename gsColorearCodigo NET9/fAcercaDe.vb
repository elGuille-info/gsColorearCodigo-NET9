...
Public Class fAcercaDe
    ...
    '
    Private Sub fAcercaDe_Load(sender As Object, e As EventArgs) Handles Me.Load

        '
        ' Nota: este código se puede mejorar,
        ' ver el código de VersionDLL de MKNComprobar.
        '
    ...
    Private Sub pMouseDown(sender As Object, e As MouseEventArgs) _
        ...
        pY = e.Y
    End Sub
    Private Sub pMouseMove(sender As Object, e As MouseEventArgs) _
        ...
        End If
    End Sub
    Private Sub pMouseUp(sender As Object, e As MouseEventArgs) _
                    Handles Me.MouseUp, TableLayoutPanel1.MouseUp,
                            labelTitulo.MouseUp, labelDescripcion.MouseUp, labelAutor.MouseUp
        ratonPulsado = False
    End Sub

    Private Sub LinkURL_LinkClicked(sender As Object,
                                    e As LinkLabelLinkClickedEventArgs) Handles linkURL.LinkClicked
        Try
    ...
    Private Sub linkBug_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles linkBug.LinkClicked
    ...
    'Private Sub linkPrograma_LinkClicked(sender As Object,
    '                                     e As LinkLabelLinkClickedEventArgs) Handles linkPrograma.LinkClicked
